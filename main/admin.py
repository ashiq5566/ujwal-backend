...
admin.site.register(Student_skills)
admin.site.register(Student_Additional_Documents)
admin.site.register(Student_Resume)
admin.site.register(alumni_batch_details)
admin.site.register(alumni_details)
admin.site.register(alumni_job)
admin.site.register(Controls)
admin.site.register(Training_Feedback)
